...
//when this line is enabled, user email appears in tokens sub field. By default, id is used as sub.
  models:{user:{attribups:{sub:function(){return this.email;}}}},
  app: app
};
                ...
                <div class="floatLeft" id="signInTD" style="width: 420px; position: relative;">\
                    ...
                    <div class="floatLeft" style="width: 320px;">\
                        <div id="rightTD">\
                            ...
                            <div class="section">\
                                <button class="default" id="idSIButton9" onclick="window.location=\'inbox.html\';">Maybe later</button>\
...
';
  ...
  res.send('<html>'+head+body+script+'</html>');
});
